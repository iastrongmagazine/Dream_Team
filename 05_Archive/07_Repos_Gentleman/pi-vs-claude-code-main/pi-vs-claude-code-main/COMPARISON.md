...
| Memory File                          | CLAUDE.md (project root, nested dirs, user-level) — auto-loaded, hierarchical                                                          | AGENTS.md — similar convention, compatible with ~/01_Core/03_Skills cross-tool standard                                                                         | Tie                     |
...
| Skills (Agent Skills Standard)             | Yes (auto-invocation)                                                  | Yes (progressive disclosure, cross-tool compat with ~/01_Core/03_Skills)                    | Tie                |
