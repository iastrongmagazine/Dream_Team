...
cp -r Gentleman-Skills/curated/* ~/01_Core/03_Skills/

# Or copy specific skills
cp -r Gentleman-Skills/curated/react-19 ~/01_Core/03_Skills/
cp -r Gentleman-Skills/curated/typescript ~/01_Core/03_Skills/
```
...
2. Copy the skill folder(s) you want:
   ```bash
   cp -r curated/react-19 ~/01_Core/03_Skills/
   ```

3. Reference the skill in your project's `CLAUDE.md` or global `~/.claude/CLAUDE.md`:
   ```markdown
   ## Skills
   When working with React, read `~/01_Core/03_Skills/react-19/SKILL.md` first.
   ```
